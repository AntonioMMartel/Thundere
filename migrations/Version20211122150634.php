 ...
 */
final class Version20211122150634 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Implementacion de tokens de usuario (Voy a cambiarla por la que usa symfony por defecto porque paso)';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE user_token (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, token VARCHAR(255) NOT NULL, expires_in DATETIME NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        )');
        ...
        // Tengo cosas en la base de datos con nulos random que no deberian existir, reseteare la base d datos de chilling y ya esta
